...
// Fixed scroll detection for active tabs
window.addEventListener("scroll", () => {
    ...
    // Desktop nav - check href attribute instead of class
    navLi.forEach(li => {
    ...
    // Mobile nav (keep your existing implementation)
    mobilenavLi.forEach(li => {
        li.classList.remove("activeThismobiletab");
        li.classList.contains(current) && li.classList.add("activeThismobiletab");
    });
});
