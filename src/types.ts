...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    title: "Quanta",
    category: "Web Dev",
    description: "A fully responsive React SaaS experience combining interactive WebGL effects, animated data visualizations, custom motion systems, and a product-focused dashboard interface.",
    details: "Interactive SaaS Finance Platform Concept. A fully responsive React SaaS experience combining interactive WebGL effects, animated data visualizations, custom motion systems, and a product-focused dashboard interface.",
    tags: ["React 18", "Vite 5", "WebGL (OGL)", "Motion", "SaaS", "UI/UX", "GLB Model", "Node.js"],
    status: "Completed",
    demoUrl: "https://saas-quanta.vercel.app/",
    githubUrl: "https://github.com/Hemal0651/quanta_saas",
    architectureDetails: "React 18 & Vite 5 -> OGL WebGL & GLB 3D Pipeline -> Framer Motion v13 & Vanilla CSS3."
  },
  {
    id: "p-everloom",
    title: "EVERLOOM",
    category: "Web Dev",
    description: "Luxury fashion e-commerce landing page built with HTML5, CSS3 & vanilla JavaScript featuring GSAP animations, interactive shopping UI, responsive design, and zero frameworks.",
    details: "Luxury Fashion E-Commerce Landing Page. Built with HTML5, CSS3 & vanilla JavaScript featuring GSAP animations, interactive shopping UI, responsive design, and zero frameworks.",
    tags: ["Vanilla JS", "HTML5", "CSS3", "GSAP v3", "E-Commerce", "Interactive UI", "Responsive"],
    status: "Completed",
    demoUrl: "https://everloom-conceptual.vercel.app/",
    githubUrl: "https://github.com/Hemal0651/everloom",
    architectureDetails: "Zero Frameworks -> Vanilla JS (ES6+) & GSAP v3.12.5 -> Custom CSS3 & Inline SVG Graphics."
  },
  {
    id: "p-porsche",
