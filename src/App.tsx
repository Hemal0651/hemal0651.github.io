...
export default function App() {
  ...
  // Ensure the page always starts at the top / hero section on refresh or initial load
  React.useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-[#f8fafc] dark:bg-[#030303] text-slate-900 dark:text-slate-100 selection:bg-slate-200 dark:selection:bg-slate-800 selection:text-slate-900 dark:selection:text-white overflow-x-hidden font-sans">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-md bg-slate-50/80 dark:bg-[#030303]/80 border-b border-slate-200 dark:border-white/5">
        <div className="max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-14 xl:px-16 py-4.5 flex items-center justify-between">
      ...
      <main className="max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-14 xl:px-16">
        {/* HERO SECTION */}
        <AestheticHero portfolioData={portfolioData} />

        {/* CORE ABOUT MISSION SUMMARY BLOCK */}
        <section id="about" className="w-full py-24 grid grid-cols-1 md:grid-cols-12 gap-12 items-center border-b border-slate-200 dark:border-white/5 relative">
      ...
      <footer className="border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-[#030303] py-12">
        <div className="max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-14 xl:px-16 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 text-center md:text-left gap-4 font-sans">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-slate-500">
            ...
            {portfolioData.twitter && (
              <a href={portfolioData.twitter} target="_blank" rel="noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors">X (Twitter)</a>
            )}
          </div>
        </div>
      </footer>
