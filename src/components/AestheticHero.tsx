...
export default function AestheticHero({ portfolioData }: AestheticHeroProps) {
  ...
  return (
    <section className="relative min-h-[calc(100vh-4.75rem)] flex flex-col justify-center py-6 sm:py-10 md:py-12 lg:py-16 border-b border-slate-200 dark:border-white/5">
      {/* Main Grid Wrapper */}
      <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-14 items-center relative z-10 my-auto">
        
        {/* Left Column: Premium Bio */}
        <div className="md:col-span-7 space-y-6 lg:space-y-8 flex flex-col justify-center md:-mt-6 lg:-mt-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-650 dark:text-slate-400 text-sm sm:text-base leading-relaxed font-sans font-light max-w-3xl">
              Hi, I’m <strong className="text-slate-900 dark:text-white font-semibold">{portfolioData.name}</strong>, a 4th-year 1st-semester undergraduate student pursuing a B.Sc. in Computer Science and Engineering at the University of Asia Pacific (UAP). Passionate about full-stack web engineering with TypeScript, React, Tailwind CSS, Node.js, Python/Django, and interactive UI design concepts.
            </p>
          </div>

          {/* Luxury Rounded Bento Stats Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-3xl">
            ...
            >
              ...
              <div className="min-w-0">
                <span className="text-[9px] text-slate-500 dark:text-slate-500 font-mono block tracking-wider">FRONTEND</span>
                <span className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-wide truncate block">TS / React / Tailwind</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="min-w-0">
                <span className="text-[9px] text-slate-500 dark:text-slate-500 font-mono block tracking-wider">BACKEND & DB</span>
                <span className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-wide truncate block">Node / Django / SQL</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="min-w-0">
                <span className="text-[9px] text-slate-500 dark:text-slate-500 font-mono block tracking-wider">ACADEMICS</span>
                <span className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-wide truncate block">4th Year, 1st Sem</span>
              </div>
            </motion.div>
          </div>
        ...
        <div className="md:col-span-5 relative w-full flex flex-col justify-center px-1.5 sm:px-0">
            ...
            {activeTab === "profile" ? (
              ...
              >
                ...
                >
                  ...
                  {/* Sleek Identity Pass Banner & Photo (16:9 Aspect Ratio) */}
                  <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden bg-slate-100 dark:bg-[#0c101d] border border-slate-200/80 dark:border-white/10 flex items-center justify-center shadow-inner">
                    <img
                      src="/hemal_avatar.png"
                      alt="Hemal Farouqe"
                    ...
                    <div className="hidden absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-950 flex flex-col items-center justify-center text-center p-4">
                      <div className="w-14 h-14 rounded-full bg-orange-500/10 border border-orange-500/30 flex items-center justify-center mb-2">
                        <span className="font-mono font-bold text-orange-500 text-xl">HF</span>
                      </div>
                      <span className="text-xs font-mono text-slate-400 uppercase tracking-widest font-bold">Hemal Farouqe</span>
                    </div>

                    {/* Edge-pinned Glowing Passing Year Watermark inside image frame */}
                    <div className="absolute bottom-2.5 left-2.5 px-2.5 py-1 bg-[#030303]/80 backdrop-blur-md rounded-lg border border-white/15 text-[9px] font-mono font-bold uppercase tracking-wider text-white">
                      CLASS OF 2027
                    </div>
                    <div className="absolute top-2.5 right-2.5 px-2 py-0.5 bg-emerald-500/20 backdrop-blur-md rounded-md border border-emerald-500/40 text-[8.5px] font-mono font-bold uppercase tracking-wider text-emerald-400">
                      CSE VERIFIED
                    </div>
                  </div>
                  ...
                  <div className="mt-3.5 space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-base font-black text-slate-900 dark:text-white uppercase tracking-wider font-sans leading-tight">
                          Hemal Farouqe
                        </h3>
                        <span className="text-[9px] font-mono text-slate-400 dark:text-slate-500 tracking-wider">SEC: B • ID: 0651</span>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-[11px] font-mono border-t border-slate-100 dark:border-white/5 pt-2.5">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="text-slate-800 dark:text-slate-300 font-bold">4th Year, 1st Sem</p>
                      </div>
                      <div className="space-y-0.5">
                    ...
                    <div className="flex items-center gap-2 pt-2.5 border-t border-slate-100 dark:border-white/5 text-[10px] font-mono text-slate-500 dark:text-slate-450 justify-between">
          ...
          {/* Aesthetic Segmented Selector for the Hub placed beneath the card */}
          <div className="flex max-w-full overflow-x-auto no-scrollbar whitespace-nowrap gap-1 mt-4 p-1 bg-slate-100/90 dark:bg-[#070a13] border border-slate-200/60 dark:border-white/10 rounded-xl w-fit self-center z-20 shadow-sm animate-fade-in">
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 font-sans font-bold text-[10px] sm:text-[11px] rounded-lg transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 ${
                activeTab === "profile"
                  ? "bg-[#F97316] text-white dark:text-black shadow-md shadow-orange-500/20 font-extrabold"
            ...
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 font-sans font-bold text-[10px] sm:text-[11px] rounded-lg transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 ${
                activeTab === "code"
                  ? "bg-slate-900 dark:bg-white text-white dark:text-black shadow-sm font-extrabold"
                  : "text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white"
              }`}
            >
